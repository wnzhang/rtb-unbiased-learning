...
aucrmse=../results/auc-rmse-ce-subtest
...
for campaign in $campaigns; do
    ...
    #python ../python/auc_rmse_subtest_large_buffer.py $folder/$campaign/train.wyzx.imp.txt $folder/$campaign/test.yzx.txt $aucrmse/test.aucRmse.imp.$campaign.txt $aucrmse/test.ar.rounds.imp.$campaign.txt

    #python ../python/auc_rmse_subtest_large_buffer.py $folder/$campaign/train.wyzx.uimp.txt $folder/$campaign/test.yzx.txt $aucrmse/test.aucRmse.uimp.$campaign.txt $aucrmse/test.ar.rounds.uimp.$campaign.txt

    #python ../python/auc_rmse_subtest_large_buffer.py $folder/$campaign/train.wyzx.kimp.txt $folder/$campaign/test.yzx.txt $aucrmse/test.aucRmse.kimp.$campaign.txt $aucrmse/test.ar.rounds.kimp.$campaign.txt

    python ../python/auc_rmse_subtest_large_buffer.py $folder/$campaign/train.wyzx.bid.txt $folder/$campaign/test.yzx.txt $aucrmse/test.aucRmse.bid.$campaign.txt $aucrmse/test.ar.rounds.bid.$campaign.txt

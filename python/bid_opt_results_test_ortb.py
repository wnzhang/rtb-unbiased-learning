...
output_file   = result_folder + '../ortb.all.bid.opt.results.test.txt'
output_file_2 = result_folder + '../ortb.all.bid.opt.click.results.test.txt'
output_file_3 = result_folder + '../ortb.all.bid.opt.ecpc.results.test.txt'
output_file_4 = result_folder + '../ortb.all.bid.opt.imps.results.test.txt'
...
props = [2, 4, 8, 16, 32, 64]
props.reverse()
for prop in props:
    for campaign in campaigns:
        fo.write('{}\t{}'.format(prop, campaign))
        print '{}\t{}'.format(prop, campaign)
        for setting in unbias_setting_ls:
